...
- Moved the English homepage to `README.en.md` and added language switch links.

## 0.2.2

- Simplified the repository around the Skill, field notes, and examples.
- Removed benchmark/schema/validator/test scaffolding.
- Added a complete beginner flow: install → start → intervene → stop → receive a final exploration result.
- Defined the final result as path, unexpected discoveries, new questions, cognitive shifts, open branches, and key sources.

## 0.2.1

- Added field notes from repeated real human–AI exploration and failure cases.
